-- Fix: Exclude closed restaurants from ranked dishes
-- Restaurants with is_open = false should not appear on homepage
...
BEGIN
  ...
  SELECT
    ...
    ROUND(AVG(v.rating_10), 1)::NUMERIC(3,1) AS avg_rating,
    ROUND((
      3959 * ACOS(
  ...
  AND r.is_open = true  -- Only include open restaurants
