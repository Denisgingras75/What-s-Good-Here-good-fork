  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow: isActive
            ? '0 8px 24px rgba(0,0,0,0.5), 0 0 0 2px var(--color-primary), 0 0 20px rgba(244, 162, 97, 0.3), inset 0 1px 0 rgba(255,255,255,0.1)'
            : '0 8px 24px rgba(0,0,0,0.5), 0 4px 12px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.15), inset 0 -1px 0 rgba(0,0,0,0.3)',
        }}
      >
        {imageSrc ? (
          <img
