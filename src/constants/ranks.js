...
export const RANKS = [
  ...
  { title: 'Expert', emoji: '\u2B50', color: '#F59E0B', minBadges: 8, description: 'Trusted contributor' },
  { title: 'Legend', emoji: '\uD83D\uDC51', color: '#9333EA', minBadges: 15, description: 'Elite status achieved' },
]
